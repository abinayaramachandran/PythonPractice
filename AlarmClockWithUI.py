...
time_format=Label(clock, text= "Enter time in 24 hour format!",bg="grey",font="Arial").place(x=60,y=120)
addTime = Label(clock,text = "Hour  Min   Sec",font=60).place(x = 110)
setYourAlarm = Label(clock,text = "Wakeup Time : ",fg="blue",relief = "solid",font=("Helevetica",7,"bold")).place(x=0, y=29)
